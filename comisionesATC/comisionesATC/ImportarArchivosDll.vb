...
Module ImportarArchivosDll
    ...
    Public Function importarExcel(ByVal tabla As DataGridView) As String
        ...
        If myFileDialog.FileName.ToString <> "" Then
            ...
            Try
                ...
                End Try
            Catch ex As Exception
                MsgBox("Favor de seleccionar el archivo que desea importar", MsgBoxStyle.Exclamation, "Información")
            End Try
