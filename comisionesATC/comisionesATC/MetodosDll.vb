...
Module MetodosDll
    ...
    Public Function CapturarRegistros(ByVal DgDatos As DataGridView, ByVal PBCargrando As ProgressBar, ByVal DGSinComision As DataGridView, ByVal DGConComision As DataGridView,
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Favor de seleccionar el archivo que desea importar", MsgBoxStyle.Information, Title:="Comisiones")
        End Try
    End Function

    '
    Public Function GenerarReporte(ByVal CBTipoReporte As ComboBox, ByVal CBRuta As ComboBox, ByVal DGMayor As DataGridView, ByVal DGMenor As DataGridView, ByVal LbRuta As Label, ByVal Tabreporte As TabControl,
                              ByVal TabMayor As TabPage, ByVal TabMenor As TabPage, ByVal BtnReporte As Button, ByVal LbRango As Label, ByVal CBRango As ComboBox) As Integer
